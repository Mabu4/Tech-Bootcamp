...
const subtitle = "Aktuelles";
const title = "Unsere populärsten Rezensionen";
...
let TestimonialListContent = [
  {
    ...
    title: "Somrat Islam",
    desc: "Das war eine unglaubliche tolle Zeit bei euch. Ich konnte mich von kleinen Projekten bis zu den großen Gruppenprojekte super durcharbeiten und habe es in 6 Monate geschafft einen Job zu bekommen",
    dige: "Frontend Entwickler",
    ratingcount: "5.28",
  },
  {
...
class TestimonialSection extends Component {
  render() {
    return (
      <div
        className="testimonial-section padding-top padding-bottom"
